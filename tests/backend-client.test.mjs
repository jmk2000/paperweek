...
test('offline storage defaults on but preserves an explicit opt-out',()=>{const s=storage();assert.equal(preferences(s).offline,true);setPreferences({offline:false},s);assert.equal(preferences(s).offline,false);});
